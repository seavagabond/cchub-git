...
--
-- Host: localhost
-- Generation Time: Apr 15, 2014 at 09:50 AM
...
CREATE TABLE IF NOT EXISTS `dr_authmap` (
...
--
-- Table structure for table `dr_backup_migrate_destinations`
--

CREATE TABLE IF NOT EXISTS `dr_backup_migrate_destinations` (
...
--
-- Table structure for table `dr_backup_migrate_profiles`
--

CREATE TABLE IF NOT EXISTS `dr_backup_migrate_profiles` (
...
--
-- Table structure for table `dr_backup_migrate_schedules`
--

CREATE TABLE IF NOT EXISTS `dr_backup_migrate_schedules` (
  `schedule_id` varchar(255) NOT NULL DEFAULT '0' COMMENT 'The primary identifier for a profile.',
  `name` varchar(255) NOT NULL COMMENT 'The name of the profile.',
  `source_id` varchar(255) NOT NULL DEFAULT 'db' COMMENT 'The dr_backup_migrate_destination.destination_id of the source to backup from.',
  `destination_id` varchar(255) NOT NULL DEFAULT '0' COMMENT 'The dr_backup_migrate_destination.destination_id of the destination to back up to.',
  `profile_id` varchar(255) NOT NULL DEFAULT '0' COMMENT 'The primary identifier for a profile.',
...
CREATE TABLE IF NOT EXISTS `dr_batch` (
...
CREATE TABLE IF NOT EXISTS `dr_block` (
...
CREATE TABLE IF NOT EXISTS `dr_blocked_ips` (
...
CREATE TABLE IF NOT EXISTS `dr_block_custom` (
...
CREATE TABLE IF NOT EXISTS `dr_block_node_type` (
...
CREATE TABLE IF NOT EXISTS `dr_block_role` (
  `module` varchar(64) NOT NULL COMMENT 'The block’s origin module, from dr_block.module.',
  `delta` varchar(32) NOT NULL COMMENT 'The block’s unique delta within module, from dr_block.delta.',
...
CREATE TABLE IF NOT EXISTS `dr_cache` (
...
--
-- Table structure for table `dr_cache_admin_menu`
--

CREATE TABLE IF NOT EXISTS `dr_cache_admin_menu` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_block` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_bootstrap` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_field` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_filter` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_form` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_image` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_menu` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_page` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_path` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_cache_update` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
...
CREATE TABLE IF NOT EXISTS `dr_date_formats` (
...
CREATE TABLE IF NOT EXISTS `dr_date_format_locale` (
...
CREATE TABLE IF NOT EXISTS `dr_date_format_type` (
  `type` varchar(64) NOT NULL COMMENT 'The date format type, e.g. medium.',
...
CREATE TABLE IF NOT EXISTS `dr_field_config` (
...
CREATE TABLE IF NOT EXISTS `dr_field_config_instance` (
...
--
-- Table structure for table `dr_field_data_body`
--

CREATE TABLE IF NOT EXISTS `dr_field_data_body` (
...
CREATE TABLE IF NOT EXISTS `dr_field_data_comment_body` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
CREATE TABLE IF NOT EXISTS `dr_field_data_field_image` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Table structure for table `dr_field_data_field_tags`
--

CREATE TABLE IF NOT EXISTS `dr_field_data_field_tags` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Table structure for table `dr_field_revision_body`
--

CREATE TABLE IF NOT EXISTS `dr_field_revision_body` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
CREATE TABLE IF NOT EXISTS `dr_field_revision_comment_body` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
CREATE TABLE IF NOT EXISTS `dr_field_revision_field_image` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
--
-- Table structure for table `dr_field_revision_field_tags`
--

CREATE TABLE IF NOT EXISTS `dr_field_revision_field_tags` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
...
CREATE TABLE IF NOT EXISTS `dr_file_managed` (
...
CREATE TABLE IF NOT EXISTS `dr_file_usage` (
...
CREATE TABLE IF NOT EXISTS `dr_filter` (
...
CREATE TABLE IF NOT EXISTS `dr_filter_format` (
...
CREATE TABLE IF NOT EXISTS `dr_flood` (
...
CREATE TABLE IF NOT EXISTS `dr_history` (
  ...
  `nid` int(11) NOT NULL DEFAULT '0' COMMENT 'The dr_node.nid that was read.',
  `timestamp` int(11) NOT NULL DEFAULT '0' COMMENT 'The Unix timestamp at which the read occurred.',
  PRIMARY KEY (`uid`,`nid`),
  KEY `nid` (`nid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='A record of which dr_users have read which dr_nodes.';
...
CREATE TABLE IF NOT EXISTS `dr_image_effects` (
...
CREATE TABLE IF NOT EXISTS `dr_image_styles` (
...
CREATE TABLE IF NOT EXISTS `dr_menu_custom` (
...
CREATE TABLE IF NOT EXISTS `dr_menu_links` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contains the individual links within a menu.' AUTO_INCREMENT=329 ;
...
CREATE TABLE IF NOT EXISTS `dr_menu_router` (
...
CREATE TABLE IF NOT EXISTS `dr_node_access` (
...
CREATE TABLE IF NOT EXISTS `dr_node_comment_statistics` (
...
CREATE TABLE IF NOT EXISTS `dr_node_revision` (
  ...
  KEY `nid` (`nid`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores information about each saved version of a dr_node.' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `dr_node_type` (
  ...
  PRIMARY KEY (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores information about all defined dr_node types.';
...
CREATE TABLE IF NOT EXISTS `dr_rdf_mapping` (
...
CREATE TABLE IF NOT EXISTS `dr_registry` (
...
CREATE TABLE IF NOT EXISTS `dr_registry_file` (
...
CREATE TABLE IF NOT EXISTS `dr_role` (
...
CREATE TABLE IF NOT EXISTS `dr_role_permission` (
...
CREATE TABLE IF NOT EXISTS `dr_search_dataset` (
...
CREATE TABLE IF NOT EXISTS `dr_search_index` (
...
CREATE TABLE IF NOT EXISTS `dr_search_node_links` (
  ...
  `caption` longtext COMMENT 'The text used to link to the dr_node.nid.',
...
CREATE TABLE IF NOT EXISTS `dr_search_total` (
...
CREATE TABLE IF NOT EXISTS `dr_semaphore` (
...
CREATE TABLE IF NOT EXISTS `dr_sequences` (
...
CREATE TABLE IF NOT EXISTS `dr_shortcut_set` (
...
CREATE TABLE IF NOT EXISTS `dr_shortcut_set_users` (
...
CREATE TABLE IF NOT EXISTS `dr_system` (
...
CREATE TABLE IF NOT EXISTS `dr_taxonomy_index` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The dr_node.nid this record tracks.',
...
CREATE TABLE IF NOT EXISTS `dr_taxonomy_term_data` (
...
CREATE TABLE IF NOT EXISTS `dr_taxonomy_term_hierarchy` (
...
CREATE TABLE IF NOT EXISTS `dr_taxonomy_vocabulary` (
...
CREATE TABLE IF NOT EXISTS `dr_url_alias` (
...
CREATE TABLE IF NOT EXISTS `dr_variable` (
...
CREATE TABLE IF NOT EXISTS `dr_watchdog` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.' AUTO_INCREMENT=301 ;
